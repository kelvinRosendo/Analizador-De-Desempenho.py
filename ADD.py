...
sono = int(input("você tem dormido quantas horas por noite ?, {:.2f} ").format(nome))
alimentação = int(input("quantas refeições você tem feito ?, {:.2f} ").format(nome))
...
if sono < 6:
    print("acho que você deve regular seu sono, aqui isso deve te ajudar: https://www.vigilantesdopeso.com.br/br/artigos/como-regular-sono")
